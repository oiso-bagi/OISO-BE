...
type QueryRawMock = jest.Mock<Promise<unknown[]>, [TemplateStringsArray]>;
...
describe('DashboardRepository', () => {
  ...
  function getLastRawQueryText(): string {
    const lastCall: [TemplateStringsArray] | undefined =
      prismaService.$queryRaw.mock.calls.at(-1);
    const strings: TemplateStringsArray | undefined = lastCall?.[0];
